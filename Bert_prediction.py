...
## Se obtiene la lista de conceptos/carreras que estan en ambos dataframes
...
predict_batch_now=1000 # se define cuantas predicciones se van a hacer antes de guardar los resultados, limpiar memoria ram y empezar con el siguiente lote
...
print(" ")
df1_centroid,df1_matched=Bert_functions.centroid_df(df1,columns=["concepto","cuerpo_pre"],predict_batch=predict_batch_now,batch_size=batch_size_now)
...
print(" ")
df2_centroid,df2_matched_centroid=Bert_functions.centroid_df(df2,columns=["universidad","carrera","cuerpo_pre"],predict_batch=predict_batch_now,batch_size=batch_size_now)
...
df_ofertas_similitud.to_pickle("df_ofertas_similitud.pkl")
